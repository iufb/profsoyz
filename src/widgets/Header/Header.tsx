...
export const Header = ({ locale }: { locale: string }) => {
  return (
    <header className="h-auto relative overflow-x-hidden   bg-base2 flex flex-col gap-2    w-full  ">
      ...
      <section className=" w-fit  xl:w-[1400px] mx-auto min-h-52 grid-cols-1    md:px-5   lg:px-20 px-5  grid mt-14 md:mt-0 md:grid-cols-[160px_1fr]  lg:grid-cols-[180px_1fr]  items-center md:gap-5 lg:gap-0 ">
