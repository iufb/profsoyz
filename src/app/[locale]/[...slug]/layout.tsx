...
const HeroSection = ({
  ...
  return (
    <div
      className={`${params.slug[0] == "home" ? "left-0 z-0 right-0 before:w-full before:bg-brush2 before:fill-inherit  before:h-2 md:before:h-5  relative before:z-50 before:absolute before:left-0 before:right-0  before:bg-repeat-x before:-bottom-0  md:before:-bottom-0     " : "hidden"} `}
    >
      <div className=" left-0 right-0 top-0 bottom-0 absolute opacity-20 bg-base1 " />
      <img className="-z-20" alt="hero-bg" src="/hero.jpg" />
      {/* <AnimatedText */}
